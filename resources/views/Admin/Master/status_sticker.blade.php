...
@section('main-section')
    ...
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Stickers</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Master</li>
                <li class="breadcrumb-item active" aria-current="page">Stickers List</li>
            </ol>
        </div>
        <div>
            <button type="button" class="btn btn-outline-primary rounded" id="toggler" data-toggle="modal"
                data-target="#add_Stickers_modal">
                Add Stickers
            </button>
    ...
    <div class="responsive-background">
        <div id="add_Stickers_modal" class="modal fade" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ url('add_status_stickers') }}" class="ajax-form-submit" id="cform" method="post"
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.st == 'success') {
                        $('#add_Stickers_modal').modal('toggle');
        ...
        function load_datatable(category_id = '') {
            $('.data-table').DataTable({
                ...
                ajax: {
                    url: '{{ route("status_stickers_list") }}',
                    data: {
        ...
        function edit_status_sticker(edit_item) {
            var id = $(edit_item).data('val');
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                type: 'POST',
                url: "{{ url('get_status_sticker_data') }}",
                data: {
                    _token: CSRF_TOKEN,
                    id: id
                },
